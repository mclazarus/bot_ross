...
- `&magic_list` — renders the library (id, truncated text, author, date), chunked under Discord's 2000-char limit via `send_long()`. Text is truncated to 80 chars; use `&magic_show` for the full text.
